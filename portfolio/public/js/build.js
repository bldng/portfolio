...
module.exports = function(message, sender, type) {
  var formatted, i, item, j, len, len1, messageString, messageToDisplay;
  if (type === 'linklist') {
...
module.exports = function(message) {
  ...
  return api_reply = $.getJSON(url, function(data) {
    var allProjects, chanceToApologize, filteredInfo, filteredProjects, i, item, len;
    if (data.intent === 'projects') {
      ...
      return setTimeout(chanceToApologize, 15000);
